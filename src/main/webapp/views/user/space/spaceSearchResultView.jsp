    ...
    <div class="bg0 m-t-23 p-b-140">
      <div class="container">
        ...
        <div class="row isotope-grid">
       	...
       	<%for(Space s : list){ %>
          <div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item <%=s.getSpaceCategory()%>">
            <!-- Block2 -->
            <div class="block2">
              <div class="block2-pic hov-img0">
              	<a href="<%=thisPath%>/detail.sp?no=<%=s.getSpaceNo()%>">              	
	                <img src="<%=thisPath%>/<%= s.getSpacePic() %>" alt="IMG-PRODUCT">
              	</a>
              </div>
  
              <div class="block2-txt flex-w flex-t p-t-14">
                <div class="block2-txt-child1 flex-col-l ">
                  <a href="<%=thisPath%>/detail.sp?no=<%=s.getSpaceNo()%>" class="stext-104 cl4 hov-cl1 trans-04 js-name-b2 p-b-6">
                    <%= s.getSpaceName() %>
                  </a>
  
                  <span class="stext-105 cl3">
                    <span><%= s.getSpacePrice() %></span>원/시간
                  </span>
                </div>
              </div>
            </div>

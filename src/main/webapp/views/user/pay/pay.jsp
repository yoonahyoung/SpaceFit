...
<div class="rvlvd">
    <!-- 공간번호 보내기 -->
    <input type="hidden" value="공간번호" id="bookNo">
    ...
    <div class="rvlvd-side-a">
      ...
      <table class="table">
         ...
         <tr>
             ...
             <td width="500" height="44" id="roomName"> <b>A홀(큰 홀, 컬러조명, 핀조명)</b></td>
         </tr>
         <tr>
         ...
         <tr>
             ...
             <td colspan="3" id="roomCate">연습실</td>
 
         </tr>
         <tr>
             <td width="70" height="41">예약인원</td>
             <td colspan="3" id="roomMax">최대 20명</td>
      ...
      <table class="table">
         ...
         <tr>
            <td>예약날짜</td>
            <td class="right" colspan="2" id="rsvTime">2022.07.10(토) 17시 ~ 23시</td>
         </tr>
         <tr>
            <td>예약인원</td>
            <td class="right" colspan="2" id="rsvPnum">4명</td>
         </tr>
         <tr>
            <td width="390">옵션</td>
            <td>
      ...
      <br><br>
        ...
        <table class="table">
         <tr>
           ...
           <tr>
              <th>예약자 *</th>    
              <td><input type="text" size="69%" id="rsvName" readonly value="홍길동" style="background-color: #EEEEEE;" required></td>                        
           </tr>
           <tr>
              <th>연락처 *</th>    
              <td><input type="text" size="69%" id="rsvPhone" name="phone" class="phone" maxlength="13" placeholder="숫자만 입력해주세요" required></td>                        
           </tr>
           <tr>
              <th>이메일 *</th>    
              <td><input type="text" size="69%" id="rsvEmail" required placeholder="예약자 정보로 이메일이 발송됩니다. 정확한 정보인지 확인해주세요"></td>                        
           </tr>
           <tr>
              <th>사용목적</th>    
              <td><input type="text" size="69%" id="rsvFor" placeholder="촬영, 파티, 모임, 수업 등 공간의 사용 목적을 입력해주세요"></td>                        
           </tr>
           <tr>
              <th>요청사항</th>    
              <td><textarea name="bookContent" id="rsvMsg" rows="10" cols="72" style="resize:none" placeholder="남기고 싶은말을 적어주세요 (최대 500자)"></textarea></td>                        
    ...
    <div class="rvlvd-side-b">
         ...
         <tr>
            <td>보유쿠폰</td>
            <td>
               <select name="national" style="width: 100%; padding: 0px;">

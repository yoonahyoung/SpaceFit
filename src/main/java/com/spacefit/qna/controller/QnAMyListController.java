...
public class QnAMyListController extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		listCount = new QnAService().selectMyListCount(memNo);
		...
		ArrayList<QnA> list = new QnAService().selectMyQnAList(pi, memNo);
		...
		request.getRequestDispatcher("views/user/qna/qnaMyListView.jsp").forward(request, response);
	}

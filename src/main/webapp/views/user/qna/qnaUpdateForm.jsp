<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8" import="java.util.ArrayList, com.spacefit.qna.model.vo.*, com.spacefit.attachment.model.vo.*"%>
<%
...
<%@ include file="../common/userMenubar.jsp" %>
 <div class="outer">
    ...
    <br><br><br>
<form action="<%=contextPath%>/update.qa" method="post" id="update-form" enctype="multipart/form-data">
    ...
    <table class="table" id="detail-area">
        <tr>
            ...
            <script>
				$(function(){
					$("#qnaCategory option").each(function(){
						if($(this).text() == "<%=q.getQnaCategory()%>") {
            ...
            <script>
				$(function(){
					$("#spaceCategory option").each(function(){
						if($(this).text() == "<%=q.get%>") {
							$(this).attr("selected", true);
						}
					})
